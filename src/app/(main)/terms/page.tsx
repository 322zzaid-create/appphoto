...
export const metadata: Metadata = {
  ...
  description: 'Terms of Service for apex - Rules and guidelines for using our platform.',
}
    ...
    <div className="max-w-3xl">
      ...
      <div className="prose prose-invert prose-sm max-w-none space-y-6 text-white/70">
        <section>
          ...
          <p>By accessing and using apex, you agree to be bound by these Terms of Service. If you do not agree with any part of these terms, you may not use our service.</p>
        </section>

        <section>
          <h2 className="text-lg font-bold text-white">2. Description of Service</h2>
          <p>apex is a platform for discovering, sharing, and downloading wallpapers for phones, tablets, and desktops. Our service includes:</p>
        ...
        <section>
          ...
          <p>When uploading content to apex, you agree that:</p>
          <ul className="list-disc space-y-1 pl-5">
        ...
        <section>
          ...
          <ul className="list-disc space-y-1 pl-5">
            ...
            <li>apex does not claim ownership of user-uploaded content.</li>
            <li>By uploading content, you grant apex a non-exclusive license to display and distribute your content on the platform.</li>
            <li>You may not redistribute wallpapers outside of apex without the creator&apos;s permission.</li>
          </ul>
        </section>
        ...
        <section>
          ...
          <p>Wallpapers downloaded from apex are for personal use only. Commercial use of downloaded wallpapers requires explicit permission from the original creator.</p>
        </section>

        <section>
          <h2 className="text-lg font-bold text-white">8. Advertising</h2>
          <p>apex may display advertisements. Certain premium content may be unlocked by viewing advertisements. We reserve the right to change our advertising practices at any time.</p>
        </section>
        ...
        <section>
          ...
          <p>apex is provided &quot;as is&quot; without warranties of any kind. We are not liable for any damages arising from the use of our service.</p>
        </section>
