...
export const metadata: Metadata = {
  ...
  description: 'Privacy Policy for Wallpaper Hub - How we collect, use, and protect your personal information.',
}
    ...
    <div className="max-w-3xl">
      ...
      <div className="prose prose-invert prose-sm max-w-none space-y-6 text-white/70">
        <section>
          ...
          <p>When you use Wallpaper Hub, we may collect the following information:</p>
        ...
        <section>
          ...
          <ul className="list-disc space-y-1 pl-5">
            <li>To provide and maintain the Wallpaper Hub service.</li>
        ...
        <section>
          ...
          <p>Wallpapers uploaded to Wallpaper Hub remain the intellectual property of their respective creators. We do not claim ownership over user-uploaded content.</p>
        </section>

        <section>
          <h2 className="text-lg font-bold text-white">8. Children&apos;s Privacy</h2>
          <p>Wallpaper Hub is not intended for users under the age of 13. We do not knowingly collect personal information from children.</p>
        </section>
